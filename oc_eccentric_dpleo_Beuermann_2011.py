...
#From Table 2. Parameters derived from the eccentric orbit fit.
...
np.savetxt('oc_eccentric_dpleo_Beuermann_2011.out', np.c_[BJD_time, E_j, T_O, T_C, OC_s, OC_s_err], fmt='%0.7f\t%0.0f\t%0.7f\t%0.7f\t%0.7f\t%0.7f', newline='\n ')
